...
export const productQuantityInWarehouse = createAsyncThunk(
    'productQuantityInWarehouse/warehouseAPI',
...
//export const { loginPanding, loginSuccess, loginFail } = productQuantityInWarehouseSlice.actions;
