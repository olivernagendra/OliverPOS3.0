                    ...
                    <section id="contactInfoSection">
                        ...
                        <div className="input-row">
                            ...
                            <div className="input-col">
                                ...
                                <input id="tel" type="text" pattern='[0-9]{0,5}' autoComplete='off' maxLength={13} placeholder="Enter Phone Number" name='tel' value={values.tel} onChange={(e) => handleChange(e.target.name, e.target.value)} />
                            </div>
                        </div>
                        <div className="input-row">
                            <div className="input-col">
                    ...
                    <section id="shippingAddress">
                        ...
                        <div className="input-row">
                            <div className="input-col">
                                ...
                                <input type="text" id="shippingZipPostal" name='shippingZipPostal' value={values.shippingZipPostal} placeholder="Enter Zip/Postal Code" onChange={(e) => handleChange(e.target.name, e.target.value)} />     <input type="text" id="shippingZipPostal" placeholder="Enter Zip/Postal Code" />
                            </div>
                            <div className="input-col">
