...
const Closeregistertwo = (props) => {
    ...
    const printHtml = (_closeRegister) => {
            ...
            item.line_items.forEach(function (lineItem) {
                ...
                if (lineItem.Taxes) {
                    ...
                    lineItemTaxRates && lineItemTaxRates != "" && Object.keys(lineItemTaxRates).map(key => {
                        ...
                        //     var ordtax = item.order_taxes.find(oTax => oTax.RateId == key)
                        //     if (ordtax) {
        ...
        //     PrintAndroidData.push({ "rn": rowNumber++, "cms": 0, "c1": "d_lne", "c2": "", "c3": "", "bold": "0,0,0", "fs": "24", "alg": "1" });
        //     PrintAndroidData.push({ "rn": rowNumber++, "cms": 1, "c1": "Total", "c2": (_closeRegister.Actual - _closeRegister.OpeningBalance).toFixed(2), "c3": "", "bold": "0,0,0", "fs": "24", "alg": "0,2" });
    ...
    <div class="category-list">
        <table class="table-common" style="width: 100%;text-align: left;border-collapse: collapse;">
            <tbody>
                <tr>
                    <td>Total</td>
                    <td style="text-align: right;">  ${(_closeRegister.Actual - _closeRegister.OpeningBalance).toFixed(2)} </td>
                </tr>
